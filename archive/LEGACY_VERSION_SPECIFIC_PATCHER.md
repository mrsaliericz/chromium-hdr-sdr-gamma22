# Archived documentation: legacy version-specific patcher

> **Archived:** This document preserves the original hash-locked, extracted-
> browser workflow and its historical release notes. It is no longer the
> recommended installation method. See the repository's
> [main README](../README.md) for the current Gamma22Tray runtime release.
...
2. Download `Gamma22Patcher.exe` from the
   [legacy v0.3.0 release](https://github.com/mrsaliericz/chromium-hdr-sdr-gamma22/releases/tag/v0.3.0).
